            ...
            <div style={{ display: this.state.weatherData.length ? 'flex' : 'block' }}>
                <div className='leftbg' style={{ width: this.state.weatherData.length ? '20%' : '100%' }}>
                    <div className="SearchBarChilds">
                        {!this.state.weatherData.length ? <h1 className='header-title'>Climate Guru</h1> : null}
                        <h2 className="text-col">Weather check, let's see what Mother Nature has in store for you today!</h2>
                        <br></br>
